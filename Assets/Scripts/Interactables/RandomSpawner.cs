...
public class RandomSpawner : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Invoke("StuffApparition",timeBeforeInvoking);
        }
    }
    ...
    private void StuffApparition()
    {
        ...
        for (int i = 0; i < nbObjectToSpawn; i++) // Répéter nbEnemyValue l'action
        {
            ...
            Instantiate(fxSpawn, spawnPos, Quaternion.identity); // instantier un enemy sur le spawnpos              
